var requireConfig = {
    ...
    ueditor: {
      ...
      exports: 'UE',
      init: function (e) {window.ZeroClipboard = e}
    },
    util: { exports: 'util' },
    ...
    bootstrap: { exports: '$' },
    'bootstrap.switch': { deps: ['loadcss!../../components/switch/bootstrap-switch.min.css'], exports: '$' },
...
jQuery.fn.modal ? define('bootstrap', [], function () {
  ...
  return jQuery
}) : requireConfig.paths.bootstrap = '../lib/bootstrap.min', require.config(requireConfig), define('jquery', [], function () {return jQuery})