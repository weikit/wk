var requireConfig = {
  ...
  paths: {
    ...
    map:
      "https://api.map.baidu.com/getscript?v=2.0&ak=F51571495f717ff1194de02366bb8da9&services=&t=20140530104353",
  ...
  shim: {
    ueditor: {
      deps: [
        "./resource/components/ueditor/third-party/zeroclipboard/ZeroClipboard.min.js",
        "./resource/components/ueditor/ueditor.config.js"
      ],
      exports: "UE",
      init: function(e) {
    ...
    daterangepicker: {
      deps: [
        "moment",
        "loadcss!../../components/daterangepicker/daterangepicker.css"
      ]
    },
    datetimepicker: {
      deps: [
        "loadcss!../../components/datetimepicker/jquery.datetimepicker.css"
      ]
    },
    colorpicker: {
    ...
    chart: { exports: "Chart" },
    swiper: { deps: ["loadcss!../../components/swiper/swiper.min.css"] }
  }
};
jQuery.fn.modal
